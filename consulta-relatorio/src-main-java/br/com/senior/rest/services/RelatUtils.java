...
*/		}
	...
	public ResponseModelDTO callServiceRest(String url, String token, String method, String param) throws Exception {
		...
		case "put":
			...
			put.setHeader("Autorization", getAuthentication(token));
		...
		case "post":
			...
			post.setHeader("Autorization", getAuthentication(token));
		...
		case "patch":
			...
			patch.setHeader("Autorization", getAuthentication(token));
		...
		case "delete":
			...
			delete.setHeader("Autoprization", getAuthentication(token));
