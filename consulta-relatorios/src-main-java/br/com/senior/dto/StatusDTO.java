...
public class StatusDTO {
	...
	public static final String MSG_OK                      = "{\"OK\":\"Filtro enviado com sucesso.\"}";
	public static final String MSG_NOT_FOUND               = "{\"message\":\"Nenhum relatório encontrado para este filtro\"}";
